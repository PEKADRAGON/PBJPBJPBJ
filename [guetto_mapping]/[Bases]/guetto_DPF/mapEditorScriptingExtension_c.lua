...
addEventHandler('onClientResourceStart',resourceRoot,function () 
	...
	engineImportTXD ( txd, 1189 ) --Coloque o ID do objeto que você quer modificar
	col = engineLoadCOL ( "super.col" ) --Coloque o nome do arquivo COL
	engineReplaceCOL ( col, 1189 ) --Coloque o ID do objeto que você quer modificar
	dff = engineLoadDFF ( "super.dff", 0 ) --Coloque o nome do DFF e não mexa nesse 0
	engineReplaceModel ( dff, 1189 ) --Coloque o ID do objeto que você quer modificar
	engineSetModelLODDistance(1189, 5000) --ID do objeto e a distância que ele irá carregar - distancia está como 500
end)
