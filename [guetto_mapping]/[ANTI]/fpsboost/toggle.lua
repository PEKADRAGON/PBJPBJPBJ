...
addCommandHandler(antiLag_settings.cmd,
	function(x)
		...
		--	exports["life_bildirim"]:addNotification(thePlayer, "Sohbeti okuyunuz.", "success")			
		...
		--	exports["life_bildirim"]:addNotification(thePlayer, "Sohbeti okuyunuz.", "error")					
			outputChatBox("[GCRP]#ffffff O anti-lag foi desativado, se o seu computador estiver ruim, seu FPS pode diminuir.", 0, 255, 0, true)
		end
	end
)