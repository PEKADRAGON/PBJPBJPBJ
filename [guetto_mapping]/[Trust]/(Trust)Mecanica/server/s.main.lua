...
addEventHandler("onResourceStart", resourceRoot, function(res)
    outputDebugString(getResourceName(res)..' - sistema desenvolvido por: [Encomendas] - para ler models da trust!')
end)
...
colelevmec = createColCuboid(1010.943, -1029.219, 30.112, 37.9, 34, 10)
colsegandmec = createColCuboid(1056.545, -1012.606, 30.222, 3.4, 15, 10)
function protemecelev(r0_102)
  -- line: [1373, 1389] id: 102
  if configurar.proteoficina == true then
    if getElementType(r0_102) == "vehicle" then
      cancelEvent()
    else
      local r1_102 = getPedOccupiedVehicle(r0_102)
      if not isObjectInACLGroup(("user." .. getAccountName(getPlayerAccount(r0_102))), aclGetGroup(configurar.aclmec)) then
        if r1_102 then
          setElementPosition(r1_102, 1042.49, -1042.811, 31.763)
        end
        setElementPosition(r0_102, 1042.49, -1042.811, 31.763)
      end
    end
  end
end
addEventHandler("onColShapeHit", colelevmec, protemecelev)
function protemecsegand(r0_103)
  -- line: [1395, 1411] id: 103
  if configurar.proteseg == true then
    if getElementType(r0_103) == "vehicle" then
      cancelEvent()
    else
      local r1_103 = getPedOccupiedVehicle(r0_103)
      if not isObjectInACLGroup(("user." .. getAccountName(getPlayerAccount(r0_103))), aclGetGroup(configurar.aclmec)) then
        if r1_103 then
          setElementPosition(r1_103, 1058.754, -1015.741, 32.222)
        end
        setElementPosition(r0_103, 1058.754, -1015.741, 32.222)
      end
    end
  end
end
addEventHandler("onColShapeHit", colsegandmec, protemecsegand)
local r90_0 = createObject(5886, 1042.7333984375, -1029.63671875, 34.106769561768, 0, 0, 180)
local r91_0 = createMarker(1042.768, -1029.691, 31.085, "cylinder", 7, 0, 0, 0, 0)
funcionamentopt1 = false
function moveGatemec1(r0_104)
  -- line: [1463, 1477] id: 104
  if funcionamentopt1 == false then
    if getElementType(r0_104) == "vehicle" then
      cancelEvent()
    elseif isObjectInACLGroup("user." .. getAccountName(getPlayerAccount(r0_104)), aclGetGroup(configurar.aclpt)) then
      funcionamentopt1 = true
      moveObject(r90_0, 2500, 1042.7333984375, -1029.63671875, 36.903579711914, 80, 0, 0)
      setTimer(function()
        -- line: [1471, 1473] id: 105
        move_back_gatemec1()
      end, 4000, 1)
    end
  end
end
addEventHandler("onMarkerHit", r91_0, moveGatemec1)
function move_back_gatemec1()
  -- line: [1480, 1486] id: 106
  moveObject(r90_0, 2500, 1042.7333984375, -1029.63671875, 34.106769561768, -80, 0, 0)
  setTimer(function()
    -- line: [1482, 1485] id: 107
    funcionamentopt1 = false
  end, 2510, 1)
end
local r92_0 = createObject(5886, 1031.650390625, -1029.63671875, 34.106769561768, 0, 0, 180)
local r93_0 = createMarker(1031.31, -1029.554, 31.029000000000003, "cylinder", 7, 0, 0, 0, 0)
funcionamentopt2 = false
function moveGatemec2(r0_108)
  -- line: [1502, 1516] id: 108
  if funcionamentopt2 == false then
    if getElementType(r0_108) == "vehicle" then
      cancelEvent()
    elseif isObjectInACLGroup("user." .. getAccountName(getPlayerAccount(r0_108)), aclGetGroup(configurar.aclpt)) then
      funcionamentopt2 = true
      moveObject(r92_0, 2500, 1031.650390625, -1029.63671875, 36.903769561768, 80, 0, 0)
      setTimer(function()
        -- line: [1510, 1512] id: 109
        move_back_gatemec2()
      end, 4000, 1)
    end
  end
end
addEventHandler("onMarkerHit", r93_0, moveGatemec2)
function move_back_gatemec2()
  -- line: [1519, 1525] id: 110
  moveObject(r92_0, 2500, 1031.650390625, -1029.63671875, 34.106769561768, -80, 0, 0)
  setTimer(function()
    -- line: [1521, 1524] id: 111
    funcionamentopt2 = false
  end, 2510, 1)
end
local r94_0 = createObject(5886, 1020.57421875, -1029.63671875, 34.106769561768, 0, 0, 180)
local r95_0 = createMarker(1020.262, -1029.51, 30.968, "cylinder", 7, 0, 0, 0, 0)
funcionamentopt3 = false
function moveGatemec3(r0_112)
  -- line: [1540, 1554] id: 112
  if funcionamentopt3 == false then
    if getElementType(r0_112) == "vehicle" then
      cancelEvent()
    elseif isObjectInACLGroup("user." .. getAccountName(getPlayerAccount(r0_112)), aclGetGroup(configurar.aclpt)) then
      funcionamentopt3 = true
      moveObject(r94_0, 2500, 1020.57421875, -1029.63671875, 36.903769561768, 80, 0, 0)
      setTimer(function()
        -- line: [1548, 1550] id: 113
        move_back_gatemec3()
      end, 4000, 1)
    end
  end
end
addEventHandler("onMarkerHit", r95_0, moveGatemec3)
function move_back_gatemec3()
  -- line: [1557, 1563] id: 114
  moveObject(r94_0, 2500, 1020.57421875, -1029.63671875, 34.106769561768, -80, 0, 0)
  setTimer(function()
    -- line: [1559, 1562] id: 115
    funcionamentopt3 = false
  end, 2510, 1)
end
