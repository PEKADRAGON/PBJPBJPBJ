...
function togSliders(type,datas,editSticker)
	...
	if type then
		sliders = {}
		sliders.name = "Costumização"
		if type == "wheel" then
			if datas then
				sliders[1] = {name="Matiz",data=datas[1],image="textures/hue.dds",image_rot=0,type="slider",moving=false}
				sliders[2] = {name="Saturação",data=datas[2],image="textures/saturation.dds",image_rot=180,type="slider",moving=false}
				sliders[3] = {name="Brilho",data=datas[3],image="textures/brightness.dds",image_rot=0,type="slider",moving=false}
				sliders[4] = {name="Alargamento",data=datas[4],type="slider",moving=false}
				sliders[5] = {name="Ângulo de inclinação",data=datas[5],type="slider",moving=false}
				sliders[6] = {name="Desvio",data=datas[6],type="slider",moving=false}
			else
				sliders[1] = {name="Matiz",data=0,image="textures/hue.dds",image_rot=0,type="slider",moving=false}
				sliders[2] = {name="Saturação",data=0,image="textures/saturation.dds",image_rot=180,type="slider",moving=false}
				sliders[3] = {name="Brilho",data=1,image="textures/brightness.dds",image_rot=0,type="slider",moving=false}
				sliders[4] = {name="Alargamento",data=0.5,type="slider",moving=false}
				sliders[5] = {name="Ângulo de inclinação",data=0,type="slider",moving=false}
				sliders[6] = {name="Desvio",data=0.5,type="slider",moving=false}
			end
		elseif type == "sticker" then
			if editSticker then
				...
				sliders[2] = {name="Saturação",data=datas[2],image="textures/saturation.dds",image_rot=180,type="slider",moving=false}
				sliders[3] = {name="Brilho",data=datas[3],image="textures/brightness.dds",image_rot=0,type="slider",moving=false}
				sliders[4] = {name="Transparência",data=datas[4],image="textures/transparency.dds",image_rot=0,type="slider",moving=false}
				sliders[5] = {name="X Posição",data=datas[5],type="slider",moving=false}
				sliders[6] = {name="Y Posição",data=datas[6],type="slider",moving=false}
				sliders[7] = {name="X Tamanho",data=datas[7],type="slider",moving=false}
				sliders[8] = {name="Y Tamanho",data=datas[8],type="slider",moving=false}
				sliders[9] = {name="filmando",data=datas[9],type="slider",moving=false}
				sliders[10] = {name="Contorno",data=datas[10],type="switch",moving=false}
				sliders[11] = {name="Espelhamento horizontal",data=datas[11],type="switch",moving=false}
				sliders[12] = {name="Espelhamento vertical",data=datas[12],type="switch",moving=false}
			else
				sliders[1] = {name="Matiz",data=0,image="textures/hue.dds",image_rot=0,type="slider",moving=false}
				sliders[2] = {name="Saturação",data=0,image="textures/saturation.dds",image_rot=180,type="slider",moving=false}
				sliders[3] = {name="Brilho",data=1,image="textures/brightness.dds",image_rot=0,type="slider",moving=false}
				sliders[4] = {name="Transparência",data=1,image="textures/transparency.dds",image_rot=0,type="slider",moving=false}
				sliders[5] = {name="X Posição",data=datas[1],type="slider",moving=false}
				sliders[6] = {name="Y Posição",data=datas[2],type="slider",moving=false}
				sliders[7] = {name="X Tamanho",data=datas[3],type="slider",moving=false}
				sliders[8] = {name="Y Tamanho",data=datas[4],type="slider",moving=false}
				sliders[9] = {name="filmando",data=datas[5],type="slider",moving=false}
				sliders[10] = {name="Contorno",data=0,type="switch",moving=false}
				sliders[11] = {name="Espelhamento horizontal",data=0,type="switch",moving=false}
				sliders[12] = {name="Espelhamento vertical",data=0,type="switch",moving=false}
			end
		...
		if #sliders > 0 then
			...
			for i = 1,max_row do
				...
				if row then
					...
					elseif row.name == "Ângulo de inclinação" then
					...
					elseif row.name == "X Posição" then
					...
					elseif row.name == "Y Posição" then
						dxDrawText(roundNumber(row.data*1024) .. "px/1024px",boxP[1]+boxS[1]-5,boxP[2]+10,nil,nil,tocolor(222,222,222,222),1,fonts["default_10"],"right","top")
					elseif row.name == "X Tamanho" then
						dxDrawText(roundNumber(row.data*1024) .. "px/1024px",boxP[1]+boxS[1]-5,boxP[2]+10,nil,nil,tocolor(222,222,222,222),1,fonts["default_10"],"right","top")
					elseif row.name == "Y Tamanho" then
						dxDrawText(roundNumber(row.data*1024) .. "px/1024px",boxP[1]+boxS[1]-5,boxP[2]+10,nil,nil,tocolor(222,222,222,222),1,fonts["default_10"],"right","top")
