...
local validDrivebyWeapons = { [24]=true, [31]=true }
...
addEventHandler("onClientResourceStart",resourceRoot,
	function()
		setElementData(localPlayer,"driveby",nil)
...
function toggleDriveby(b,s)
	...
	if not validDrivebyWeapons[getPedWeapon(localPlayer,equipedWeapon)] then return end
	if s == "up" then
		--If so, unequip it
	...
	elseif equipedWeapon ~= 0 then
		...
		setElementData(localPlayer,"driveby",true)
	end
end
