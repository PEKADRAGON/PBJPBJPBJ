...
markers = {
    --{2252.16, 1596.6, 1006.18 - 0.9, 'cylinder',  1.5, 139, 100, 255, 0, int = 1, dim = 0};
   -- {2252.004, 1589.707, 1006.18 - 0.9, 'cylinder',  1.5, 139, 100, 255, 0, int = 1, dim = 0};

  --  {2257.325, 1596.575, 1006.18 - 0.9, 'cylinder',  1.5, 139, 100, 255, 0, int = 1, dim = 0};
   -- {2256.774, 1589.479, 1006.18 - 0.9, 'cylinder',  1.5, 139, 100, 255, 0, int = 1, dim = 0};
}
