...
bindKey("F12", "down", function()
    ...
    outputChatBox("[!] #ffffffGuetto city |  Captura de tela | Dia: ["..string.format("%02d.%02d.%02d", day, month, year).."] | Hora: ["..string.format("%02d:%02d:%02d", hours, minutes, seconds).."]", 0, 255, 0, true)
end)