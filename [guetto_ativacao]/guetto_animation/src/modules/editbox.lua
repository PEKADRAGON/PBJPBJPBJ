editbox = {
    ...
    create = function (text, id, x, y, w, h, rw, rh, maxCaracters, fade, font)
        ...
        if editbox.identificador[id].state == true then
            ...
            local textWidth = dxGetTextWidth(editbox.identificador[id].content, 1, exports['guetto_assets']:dxCreateFont('regular', 15))
            local textHeight = dxGetFontHeight(1, exports['guetto_assets']:dxCreateFont('regular', 15))
        ...
        if editbox.identificador[id] and editbox.identificador[id].isEnabledArea then 
            local textWidth = dxGetTextWidth(editbox.identificador[id].content, 1, exports['guetto_assets']:dxCreateFont('regular', 15))
            local width, height = dxGetTextSize(editbox.identificador[id].content, textWidth, 1, exports['guetto_assets']:dxCreateFont('regular', 15))
            local textX = editbox.identificador[id].x + textWidth
        ...
        dxDrawText(editbox.identificador[id].content, editbox.identificador[id].x, editbox.identificador[id].y, editbox.identificador[id].w, editbox.identificador[id].h, tocolor(255, 255, 255, fade), 1, exports['guetto_assets']:dxCreateFont('regular', 15), "left", "top")
    end;
